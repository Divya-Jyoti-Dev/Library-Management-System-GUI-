...
public class AuthFrame extends JFrame {
    ...
    private JLabel statusLabel, usernameLbl, confirmPassLbl;
    ...
    private JPanel buildCenter() {
        ...
        usernameLbl        = lbl("Username");
        confirmPassLbl     = lbl("Confirm Password");
        ...
        loginTab.addActionListener(e -> {
            ...
            confirmPassLbl.setVisible(false); confirmPassField.setVisible(false);
        ...
        regTab.addActionListener(e -> {
            ...
            confirmPassLbl.setVisible(true); confirmPassField.setVisible(true);
            statusLabel.setForeground(ACCENT_RED); statusLabel.setText("");
        });
        ...
        for (Component c : new Component[]{
                ...
                passLbl, Box.createVerticalStrut(4), passField, Box.createVerticalStrut(12),
                confirmPassLbl, Box.createVerticalStrut(4), confirmPassField, Box.createVerticalStrut(16),
    ...
    private void handleSubmit() {
        ...
        if (showingLogin) {
            ...
            String conf  = new String(confirmPassField.getPassword()).trim();
            ...
            if (conf.isEmpty()) { statusLabel.setText("Please confirm your password."); return; }
            ...
            usernameLbl.setVisible(false); usernameField.setVisible(false);
            confirmPassLbl.setVisible(false); confirmPassField.setVisible(false);
            emailField.setText(email); passField.setText(""); confirmPassField.setText("");
