...
public class BookDialog extends JDialog {
    ...
    private JTextField titleField, authorField, isbnField, copiesField, publisherField;
    ...
    public BookDialog(Frame owner, Book existing) {
        ...
        setSize(440, 560); setLocationRelativeTo(owner); setResizable(false);
    ...
    private JPanel buildForm() {
        ...
        publisherField = UITheme.styledField(20);
        ...
        addRow(p, g, 5, "Publisher", publisherField);
        return p;
    }
    ...
    private void handleSave() {
        ...
        result = new Book(title, author, isbn, copies, cat, publisher);
        dispose();
    }
